...
const [bio,setBio] = useState("Hi Everyone ,I am using ConnectSphere");
...
<div className="w-5/6 max-w-2xl min-h-[500px] backdrop-blur-2xl text-gray-300 border-2
...
<img
className='max-w-41 aspect-square rounded-full mr-6 max-sm:mt-10'
